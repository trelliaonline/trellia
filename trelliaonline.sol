...
/**
* ~ TrelliaOnline features ~
* 
* Instant staking and burn on each transaction
* 5% tax (1% burn, 4% auto distributed to holders)
* Be the proud owner of some TRT!
* 
* Website - https://trellia.online/
* Join the Telegram - https://t.me/trellia
* 
*/
...
contract TrelliaOnline is Context, IERC20, Ownable {
    ...
    string private constant _name = 'TrelliaOnline';
